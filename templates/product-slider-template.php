...
wp_enqueue_style( 'owl-theme', plugin_dir_url(__FILE__) . '../assets/css/owl.theme.default.min.css', array(), ONEPAQUC_VERSION );
?>
...
<?php wp_enqueue_script('owl-carousel', plugin_dir_url(__FILE__) . '../assets/js/owl.carousel.min.js', array('jquery'), ONEPAQUC_VERSION, true); ?>
<?php
$inline_script = "
    (function($) {
